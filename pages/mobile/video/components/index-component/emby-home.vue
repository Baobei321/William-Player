<template>
    <div class="emby-home">
            ...
            <div class="emby-home-media__list">
                <scroll-view class="emby-home-media__list-scroll" :scroll-x="true" style="width: 100%" :enhanced="true"
                    ...
                    <div class="emby-home-media__list-classify">
                        <div class="emby-home-media__list-classify__item" v-for="item in classifyList" :key="item.id"
                            @click="toVideoAll(item)">
                            <div class="emby-home-media__list-classify__item-img">
                                <image :src="setEmptyImg(item.poster)"
                                    style="width: 100%;height: 100%;position: static;" mode="aspectFill">
                                </image>
                            </div>
        ...
        <hx-list :listData="item.list" :title="item.name" v-for="item in showList" :key="item.id" type="emby"
            @clickAll="clickAll(item)"></hx-list>
    </div>
</template>
