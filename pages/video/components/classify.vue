...
const classifyList = ref([
  ...
  { id: '27', label: '恐怖', img: 'https://bkimg.cdn.bcebos.com/pic/738b4710b912c8fcc3ce413dd2558545d688d53f8bbf?x-bce-process=image/format,f_auto/watermark,image_d2F0ZXIvYmFpa2UyNzI,g_7,xp_5,yp_5,P_20/resize,m_lfit,limit_1,h_1080', background: 'linear-gradient(to bottom, #8d4615, #b06d41)' },
