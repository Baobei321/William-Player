  ...
  if (plateForm.value == 'ios') {
    ...
    if (sum == 5) {
      ...
      if (route.query.type == 'tv') {
        index = historyPlay.findIndex(
          i => i.type == route.query.type && i.movieTvId == historyObj.value.movieTvId && handleSeasonName(i.titlePlay) == handleSeasonName(historyObj.value.titlePlay)
        )
