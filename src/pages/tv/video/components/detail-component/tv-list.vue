<template>
  <div class="tv-list">
    <tv-scroll :scroll-y="true" style="width: 100%; height: 100%" :enhanced="true" :showScrollbar="false" :scrollIntoView="scrollIntoView">
      <div
        :class="['tv-list-item', tabIndex === index ? 'tv-list-active' : '']"
