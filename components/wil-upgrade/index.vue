        ...
        <nut-popup v-model:visible="showBottom" round position="bottom" :custom-style="{ height: '45%' }"
            ...
            <div class="wil-upgrade-container">
                ...
                <div class="wil-upgrade-button">
                    <nut-button custom-color="#ff6701"
                        @click="downloadInstallApp(newVersion[props.defaultProps.apkUrl])"
...
const closedPopup = () => {
    if (dFileName.value) {
        plus.io.resolveLocalFileSystemURL(dFileName.value, function (entry) {
