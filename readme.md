...
# William Player
一款适配📱 Android Phone、Android TV和Windows 的视频播放器，支持云播放(天翼云盘、夸克网盘和Webdav)，支持刮削影视元信息，播放视频等功能。界面简洁纯净，操作简单。如果您是开发者，想要自己打包app，请参考此[开发者文档](https://github.com/chenweiliang6/William-Player/blob/master/readpack.md)
...
[Releases](https://gitee.com/CWLcwl0219/William-Player/releases/download/1.4.4/app-release.apk) 根据设备的架构自行选择安装包，安装包选择见下表

| 架构          | APK                         | 说明                   |
|-------------|-----------------------------|----------------------|
| arm64-v8a   | app-phone.apk   | 适合大部分设备，手机和平板多数为此架构     |
